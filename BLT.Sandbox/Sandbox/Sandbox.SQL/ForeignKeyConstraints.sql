--USER FKs
ALTER TABLE [dbo].[User] ADD CONSTRAINT [FK_dbo.User_dbo.Client_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([Id]) ON DELETE CASCADE

--CLIENT FKs
--ALTER TABLE [dbo].[Client] ADD CONSTRAINT [FK_dbo.Client_dbo.Project_LatestProject_Id] FOREIGN KEY ([LatestProject_Id]) REFERENCES [dbo].[Project] ([Id])

--CAMPAIGN FKs
ALTER TABLE [dbo].[Campaign] ADD CONSTRAINT [FK_dbo.Campaign_dbo.Client_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([Id]) ON DELETE CASCADE
...
ALTER TABLE [dbo].[Project] ADD CONSTRAINT [FK_dbo.Project_dbo.Client_ClientId] FOREIGN KEY ([ClientId]) REFERENCES [dbo].[Client] ([Id])
